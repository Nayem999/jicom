                	...
                	<table class="table table-bordered">
                        <tbody>
                          <tr>
                            ...
                            <th class="col-xs-7"><?php echo $this->tec->formatMoney($this->purchases_model->purchasesAmount('total')); ?></th>
                          </tr>
                          <tr>
                            <th class="col-xs-5">Total Paid Amount</th>
                            <th class="col-xs-7"><?php echo $this->tec->formatMoney($this->purchases_model->purchasesAmount('paid')); ?></th>
                          </tr>
                          <tr>
                            <th class="col-xs-5">Total Due Amount </th>
                            <th class="col-xs-7"><?php echo $this->tec->formatMoney($tdeu); ?></th>
                          </tr>
                        </tbody>
                      </table>
                     </div>
...
<script>
    ...
    var content = "<html> <br><p style='text-align:center'>Purchases List</p><style> table {font-family: arial, sans-serif;border-collapse: collapse;width: 100%;}td, th {border: 1px solid #dddddd;text-align: left;padding: 2px;} tr:nth-child(even) {background-color: #dddddd;} </style>";
