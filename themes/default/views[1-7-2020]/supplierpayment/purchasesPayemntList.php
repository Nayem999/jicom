...
<script>
    ...
    var content = "<html> <br><p style='text-align:center'>Suppliers Payemnt List</p><style> table {font-family: arial, sans-serif;border-collapse: collapse;width: 100%;} td, th {border: 1px solid #dddddd;text-align: center ;padding: 2px;} tr:nth-child(even) {background-color: #dddddd;} </style>";
