      ...
      <div class="box box-primary">        
        <div class="box-body">
          ...
          <h3 class="box-title"><strong>
            ...
            <!-- <div class="col-md-6">
            <div class="box-header"> <a href="<?= site_url('settings/backup_files'); ?>" id="backup_database" class="pull-right btn btn-primary"><i class="icon fa fa-folder-open-o"></i>
          <?= lang('Backup file'); ?>
          </a>
          <h3 class="box-title"><strong>
            <?= lang('File Backup'); ?>
              ...
              <?php
                if(! empty($files)) {
                    ...
                    foreach ($files as $file) {
                        ...
                        echo '<strong>' . lang('backup') . ' <span class="text-primary">' . $bkdate . '</span><div class="btn-group pull-right" style="margin-top:-7px;">' . anchor('settings/download_backup/' . substr($file, 0, -4), '<i class="fa fa-download"></i> ' . lang('download'), 'class="btn btn-primary"') .' ' . anchor('settings/delete_backup/' . substr($file, 0, -4), '<i class="fa fa-trash-o"></i> ' . lang('delete'), 'class="btn btn-danger delete_file"') . ' </div></strong>';
