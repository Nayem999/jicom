          ...
          <div class="col-sm-10">
                    ...
                    <?php
                     ...
                     foreach($store as $storeInfo){  
                      ...
                      $store[$storeInfo->id] = $storeInfo->name.$cPhone; } ?>
                    <?= form_dropdown('store_id', $store, set_value('store_id'), 'id="spos_store"  data-placeholder="Select store" required="required" class="form-control select2" style="width:100%;"'); ?>
