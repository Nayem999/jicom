...
class mf_purchases extends MY_Controller
{
    ...
    /* function today_get_purchases() { 
        ...
        if($data = $this->session->userdata('group_id')==1){
            $actdata = "<a onclick=\"window.open('" . site_url('mf_purchases/view/$1') . "', 'pos_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;\" href='#' title='Print Purchase' class='tip btn btn-primary btn-xs'><i class='fa fa-file-text-o'></i></a> ";
            $actdata .= "<a href='" . site_url('mf_purchases/edit/$1') . "' title='" . lang("edit_purchase") . "' class='tip btn btn-warning btn-xs'><i class='fa fa-edit'></i></a>"; 

            $actdata .= " <a href='" . site_url('suppliers/purchases/$2') . "'   title='List of ($3)'  class='tip btn btn-warning btn-xs'><i class='fa fa-user'></i>";
            $actdata .= "<a href='" . site_url('mf_purchases/delete/$1') . "' onClick=\"return confirm('" . lang('alert_x_purchase') . "')\" title='" . lang("delete_purchase") . "' class='tip btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></a>";
          }else {
          $actdata = "<a onclick=\"window.open('" . site_url('mf_purchases/view/$1') . "', 'pos_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;\" href='#' title='Print Purchase' class='tip btn btn-primary btn-xs'><i class='fa fa-file-text-o'></i></a> ";
